...
public class PostRepositoryImpl implements PostRepositoryCustom {
    ...
    @Override
    public Page<Post> findByKw(PostSearchKeywordTypeV1 kwType, String kw, Member author, Boolean published,
                               Boolean listed, Pageable pageable) {
    ...
    private void applyKeywordFilter(PostSearchKeywordTypeV1 kwType, String kw, BooleanBuilder builder) {
        switch (kwType) {
            ...
            case content -> builder.and(post.content.containsIgnoreCase(kw));
            default -> builder.and(
