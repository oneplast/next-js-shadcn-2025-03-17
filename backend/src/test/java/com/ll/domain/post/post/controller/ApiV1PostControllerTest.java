...
public class ApiV1PostControllerTest {
    ...
    void t1() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.authorProfileImgUrl").value(post.getAuthor().getProfileImgUrl()))
    ...
    void t3() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.data.authorProfileImgUrl").value(post.getAuthor().getProfileImgUrl()))
    ...
    void t17() throws Exception {
        ...
        for (int i = 0; i < posts.size(); i++) {
            ...
            resultActions
                    ...
                    .andExpect(jsonPath("$.items[%d].authorProfileImgUrl".formatted(i)).value(post.getAuthor().getProfileImgUrl()))
